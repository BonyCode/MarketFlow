...
- фильтрует все транзакции, совершенные в 2011 году, и сортирует их по возрастанию суммы.
Вывести список неповторяющихся городов, в которых работают трейдеры.

- собирает уникальные города, где работают трейдеры, и выводит их список.
Найти всех трейдеров из Кембриджа и отсортировать их по именам.

- находит всех трейдеров, работающих в Кембридже, и сортирует их по алфавиту.
Вернуть строку со всеми именами трейдеров, отсортированными в алфавитном порядке.

- выводит имена всех трейдеров в виде строки, отсортированной по алфавиту.
Проверить, существует ли хотя бы один трейдер из Милана.

- проверяет, есть ли среди трейдеров те, кто работает в Милане, и выводит соответствующий результат.
Вывести сумму всех транзакций трейдеров из Кембриджа.

- подсчитывает и выводит общую сумму всех транзакций, совершенных трейдерами из Кембриджа.
Найти максимальную сумму среди всех транзакций.

- находит и выводит максимальную сумму транзакции.
Найти транзакцию с минимальной суммой.

- находит и выводит информацию о транзакции с минимальной суммой.
